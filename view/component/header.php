                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="detail-info pr-30 pl-30">
                                ...
                                <h3 class="title-detail"><a href="index.php?act=product_full" class="text-heading">Seeds
                    ...
                    <div class="header-right">
                        <div class="search-style-2 d-flex justify-content-center">
                            <form action="index.php?act=search" method="post">
                                <select name="iddm" class="select-active">
                                    ...
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                        <ul>
                                            ...
                                            if (isset($_SESSION['mycart']) && !empty($_SESSION['mycart'])) {
                                                foreach ($_SESSION['mycart'] as $cart) {
                                                    ...
                                                    <li>
                                                        <div class="shopping-cart-img">
                                                            <a href="index.php?act=product_full"><img alt="Nest" src="' . $hinh . '" /></a>
                                                        </div>
                                                ...
                                                echo '<div class="">There are no products in the cart</div>';
                                            }
                                            ?>
                                        </ul>
                                        <div class="shopping-cart-footer">
                                            <div class="shopping-cart-total">
                                                <h4>Total <span>$<?= $tong ?></span></h4>
                                            </div>
                                            <div class="shopping-cart-button">
                                                <a href="index.php?act=addtocart" class="outline">View cart</a>
