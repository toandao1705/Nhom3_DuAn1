        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    <a href="index.php?act=reset_password" rel="nofollow"><i class="fi-rs-home mr-5"></i>Home</a>
                    ...
                    <div class="col-xl-6 col-lg-8 col-md-12 m-auto">
                        <div class="row">
                            <div class="heading_s1">
                                <img class="border-radius-15" src="view/assets/imgs/page/reset_password.svg" alt="" />
